...
!function(){"use strict";function t(t){this.sort(t)}function n(n,o){this.model=o||{},this.paging=new t(n),this.pageCount=[]}n.prototype={attachToScope:function(t,n){var o=this;t.$watch(function(){return o.model},function(t){o.paging.pageIndex=0,n(t,o.paging,!0).then(function(t){o.pageCount.length=t.pageCount})},!0),t.$watch(function(){return o.paging},function(t,e){t.sortBy===e.sortBy&&t.pageIndex===e.pageIndex||n(o.model,t,!1)},!0)}},t.prototype={sort:function(t){null===t?delete this.sortBy:t===this.sortBy?this.sortBy=t+" desc":this.sortBy=t},toPage:function(t){this.pageIndex=t}},angular.module("ngQuickGrid").factory("SearchModel",function(){return n})}();
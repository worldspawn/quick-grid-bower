...
!function(){"use strict";function t(t,i){this.value=t,this.toJSON=function(){if(null!==this.value&&void 0!==this.value){var t=this.value;return i+t}}}function i(t){this.sort(t)}function n(t,n){this.model=n||{},this.paging=new i(t),this.pageCount=[],this.filters={}}var e={"%":function(t){this.value=t,this.toJSON=function(){if(null!==this.value&&void 0!==this.value){var t=this.value;return"%"+t+"%"}}},"%~":function(t){this.value=t,this.toJSON=function(){if(null!==this.value&&void 0!==this.value){var t=this.value;return"%"+t}}},"~%":function(t){this.value=t,this.toJSON=function(){if(null!==this.value&&void 0!==this.value){var t=this.value;return t+"%"}}},"()":function(t){this.value=t,this.toJSON=function(){if(null!==this.value&&void 0!==this.value){var t=[];return this.value.forEach(function(i){t.push(i)}),"("+t.join(",")+")"}}}};n.prototype={addFilter:function(i,n,u){var o=e[n]||t;this.filters[i]=new o(u,n)},attachToScope:function(t,i){function n(){e.paging.pageIndex=0,e.paging.filterHash=null,i(angular.extend({},e.model,{filters:e.filters}),e.paging,!0).then(function(t){null!==t.pageCount&&(e.pageCount.length=t.pageCount),e.paging.filterHash=t.filterHash})}var e=this;t.$watch(function(){return e.model},n,!0),t.$watch(function(){return e.filters},n,!0),t.$watch(function(){return e.paging},function(t,n){t.sortBy===n.sortBy&&t.pageIndex===n.pageIndex||i(angular.extend({},e.model,{filters:e.filters}),t,!1)},!0)}},i.prototype={sort:function(t){null===t?delete this.sortBy:t===this.sortBy?this.sortBy=t+" desc":this.sortBy=t},toPage:function(t){this.pageIndex=t}},angular.module("ngQuickGrid").factory("SearchModel",function(){return n})}();